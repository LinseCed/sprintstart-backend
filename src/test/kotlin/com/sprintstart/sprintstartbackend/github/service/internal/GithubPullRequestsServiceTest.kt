...
import com.sprintstart.sprintstartbackend.connectors.github.models.client.graphql.ReviewNode
import com.sprintstart.sprintstartbackend.connectors.github.models.client.graphql.ReviewThreadNode
import com.sprintstart.sprintstartbackend.connectors.github.models.client.graphql.ReviewThreadsConnection
import com.sprintstart.sprintstartbackend.connectors.github.models.client.graphql.ReviewsConnection
...
class GithubPullRequestsServiceTest {
    ...
    inner class EventPublishing {
        ...
        fun `publishes GithubPullRequestsFetchingStartedEvent on start`() = runTest {
            coEvery { repoConnectionRepository.findById(any()) } returns Optional.of(repo)
            coEvery { githubClient.fetchAllPullRequests(any()) } returns emptyList()
        ...
        fun `publishes GithubPullRequestsFetchingFailedEvent when API fails`() = runTest {
            coEvery { repoConnectionRepository.findById(any()) } returns Optional.of(repo)
            coEvery { githubClient.fetchAllPullRequests(any()) } throws RuntimeException("API error")
