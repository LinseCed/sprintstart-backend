...
/**
 * A hire's in-progress (or completed) adaptive skill-assessment interview.
 *
 ...
 * every AI call. A user has at most one meaningfully active session at a time; `/start` resumes
 * an [SkillAssessmentSessionStatus.IN_PROGRESS] session rather than spawning a duplicate.
 */
@Entity
